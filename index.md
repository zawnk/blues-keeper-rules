...
- [Commisioner Tasks](#Commissioner-Tasks)
- [Changelog](#Changelog)
...
The draft will be held in snake-order.

#### Initial Order

For the very first draft, the draft order will be randomized.
...
Using an ELC to protect a player, will take away a draft pick of the team per ELC **from the back of their draft rounds**.
...
Players dropped off a team are placed on waivers for 3 (?) days. Players with contracts keep their contracts, even after being dropped off a team. If they're not picked up during their waiver period, they become free agents, lose their current contract and can be picked up by any team. Once picked up, players become available to score for their new team the next day (cut-off is midnight PT).
...
Draft picks can be part of a trade, even though some limits apply. [The roster size](#Roster-Slots) is 24 players and teams can have 10 contracts, which means that each subsequent drafts after the initial one will have 14 rounds. Teams can also potentially protect young players with [ELCs](#Entry-Level-Contracts) up to a maximum of three. Therefore, only 11 picks are guaranteed for a team and therefore only picks 1 to 11 can be traded.
...
- Mid-season rule changes can be brought up by any team but require unanimous agreement and will be applied retroactively if possible
